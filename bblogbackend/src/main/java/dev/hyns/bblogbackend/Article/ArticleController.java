...
public class ArticleController {
    ...
    @PostMapping("/read") ResponseEntity<ArticleDTO> read(@RequestBody ArticleDTO dto) {return aser.readArticle(dto.getAid());}
    ...
    @DeleteMapping("/delete") ResponseEntity<Boolean> delete(@RequestBody ArticleDTO dto) {return aser.deleteArticle(dto.getAid());}
